...
public void prosesTransaksi(Member member, Transaksi transaksi, Barang barang){ 
        ...
        System.out.println("Silahkan belanja");         System.out.println("Masukkan ID Member");         int idMember = myObj.nextInt();   
        ...
        int temp=0;         
        do{ 
            System.out.println("Masukkan kode barang :");             temp=myObj.nextInt();             if (temp!=99){                 idBarang.add(temp); 
...
public void setTransaksi(Barang barang, int idMember, int idBarang, int banyaknya){ 
        ...
        this.idBarang.add(idBarang);         this.banyak.add(banyaknya); 
        barang.editStok(idBarang, barang.getStok(idBarang)-banyaknya);     }      public int getIdBarang(int id){         return this.idBarang.get(id); 
    }        
